    ...
    <div class="customer-service-container">
        ...
        <div class="table-container">
            <el-table :data="tableData" border v-loading="loading" style="width: 100%">
                ...
                <el-table-column prop="deviceName" label="巡检设备" width="150"></el-table-column>
                <el-table-column prop="frequency" label="巡检频次" width="150">
        ...
        <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="50%" :close-on-click-modal="false">
            <el-form ref="form" :model="form" :rules="rules" label-width="100px">
                ...
                <el-form-item label="巡检频次" prop="frequency">
                    <el-select v-model="form.frequency" placeholder="请选择巡检频次">
...
export default {
    data() {
        return {
            ...
            rules: {
                ...
                frequency: [
                    { required: true, message: "巡检频次不能为空", trigger: "blur" }
                ],
                time: [
    ...
    methods: {
        ...
        fetchData() {
            this.loading = true;
            const rtestPlanPageDTO = {
                page: this.pagination.currentPage,
                pageSize: this.pagination.pageSize,
                status: this.searchForm.status,
                deviceId: this.searchForm.deviceId
            };
            request.post('/admin/rtestPlan/list', rtestPlanPageDTO, {
                headers: {
                    'Authorization': `Bearer ${this.token}`
                }
            }).then(response => {
        ...
        handleStatusChange(row) {
            ...
            this.loading = true;
            request.post(`/admin/rtestPlan/${newStatus}?id=${row.id}`, {}, {
                headers: {
                    'Authorization': `Bearer ${this.token}`
                }
            }).then(res => {
