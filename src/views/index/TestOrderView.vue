    ...
    <div class="customer-service-container">
        ...
        <div class="table-container">
            <el-table :data="tableData" border v-loading="loading" style="width: 100%">
                ...
                <el-table-column prop="deviceName" label="检测设备" width="110"></el-table-column>
...
export default {
    ...
    methods: {
      ...
      request.get('/admin/device/zai', {
        ...
        handleView(id) {
            this.$router.push(`/index/testDetail/${id}`); // 跳转详情页
        },
        getToken() {
        ...
        fetchData() {
            ...
            request.post('/admin/testOrder/list', testOrderPageDTO, {
                headers: {
                    'Authorization': `Bearer ${this.token}`
                }
            }).then(response => {
        ...
        handleSubmit() {
            this.$refs.form.validate(valid => {
                ...
                request.post('/admin/testOrder/add', this.form, {
        ...
        handleResign(id) {
            this.$confirm("确定要取消该报修吗？", "提示", {
                ...
                .then(() => {
                    request.post(`/admin/testOrder/delete/${id}`, {}, {
                        headers: {
                            'Authorization': `Bearer ${this.token}`
                        }
                    }).then(res => {
