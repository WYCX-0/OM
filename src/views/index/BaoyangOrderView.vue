  ...
  <div class="customer-service-container">
    ...
    <div class="table-container">
      <el-table :data="tableData" border v-loading="loading" style="width: 100%">
        ...
        <el-table-column prop="deviceName" label="保养设备" width="110"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      request.post('/admin/baoyangOrder/list',  baoyangOrderPageDTO, {
        headers: {
          'Authorization': `Bearer ${this.token}`
        }
      }).then(response => {
    ...
    handleSubmit() {
      this.$refs.form.validate(valid => {
        ...
        request.post('/admin/baoyangOrder/add', this.form, {
    ...
    // 工单取消
    handleResign(id) {
      this.$confirm("确定要取消该保养吗？", "提示", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning"
      })
          .then(() => {
            request.post(`/admin/baoyangOrder/delete/${id}`, {}, {
              headers: {
                'Authorization': `Bearer ${this.token}`
              }
            }).then(res => {
