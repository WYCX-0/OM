<template>
	<view class="container">
		<view class="container">
			<view v-if="fenceCenter" class="map-container">
				<map id="mapContainer" style="width:100%;height:300rpx" :latitude="fenceCenter[1]"
					:longitude="fenceCenter[0]" :markers="markers" :circles="circles" :show-location="true"
